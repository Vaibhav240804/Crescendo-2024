            ...
            <motion.div animate={open ? "open" : "closed"} className="relative">
                ...
                >
                    <div className="w-full h-full flex flex-col gap-2">
                        <Option setOpen={setOpen} Icon={<AiFillRobot style={{
                            fontSize: 25,
                            color: 'black'
                        }} />} text="Chat Bot" />
                        <Divider />
                        <div className="h-[300px]">
                            <div className="flex flex-col gap-2 h-full overflow-y-auto">
                                {msgList.map((msg, idx) => (
                                    ...
                                    //     <span>{msg.msg}</span>
                                    // </div>
                                    <div key={idx} className={`${msg.type === 'user' ? "self-end" : "self-start"} w-[70%]`}>
                                        <div className='w-full text center border rounded-xl flex flex-col items-start justify-center p-2.5 break-words'>
                                            <div className={`${msg.type === 'user' ? "text-blue-700" : "text-slate-700"} font-bold text-xs`}>
